...
أجب دائماً باللغة العربية، بإيجاز ووضوح.
إذا كان السؤال عن أحد الحقول الواردة أدناه، استخدم بياناتها بدقة. إذا كان السؤال عاماً عن الجيولوجيا أو صناعة النفط أو أي موضوع آخر، أجب من معرفتك العامة بشكل مفيد ومباشر.
...
exports.handler = async function (event) {
  ...
  try {
    const url = `https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flasا:generateContent?key=${apiKey}`;
